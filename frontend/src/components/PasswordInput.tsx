    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-3 py-2 pr-10 bg-bg1 border border-muted rounded text-primary focus:outline-none focus:border-aqua-bright transition-colors duration-200 ease-out"
        />
        <button
          type="button"
