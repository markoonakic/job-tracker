    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-3 py-2 pr-10 bg-bg2 rounded text-fg1 border border-tertiary focus:border-aqua-bright focus:outline-none transition-all duration-200 ease-in-out"
        />
        <button
          type="button"
