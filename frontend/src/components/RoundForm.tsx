      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="col-span-2">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 bg-bg3 text-fg1 placeholder-muted border focus:border-aqua-bright focus:outline-none transition-all duration-200 ease-in-out rounded resize-y"
          />
        </div>
