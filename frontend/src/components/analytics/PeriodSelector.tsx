    ...
    <div className="flex gap-2 mb-6">
      {PERIODS.map((period) => (
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors duration-200 ease-out cursor-pointer focus:outline-none focus:ring-2 focus:ring-accent-aqua/50 ${
