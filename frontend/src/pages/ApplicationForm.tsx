          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-tertiary border border-muted rounded text-fg1 placeholder-gray focus:outline-none focus:border-accent-aqua transition-[border-color_200ms_ease]"
                required
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-tertiary border border-muted rounded text-fg1 focus:outline-none focus:border-accent-aqua transition-[border-color_200ms_ease]"
                required
              >
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 bg-tertiary border rounded text-fg1 placeholder-gray focus:outline-none focus:border-accent-aqua transition-[border-color_200ms_ease] ${
            ...
            <div>
              ...
              <textarea
                ...
                rows={6}
                className="w-full px-3 py-2 bg-tertiary border border-muted rounded text-fg1 placeholder-gray focus:outline-none focus:border-accent-aqua transition-[border-color_200ms_ease] resize-y"
              />
            </div>
          </div>
